...
export type TokenTrade = Trade<Token, Token | Ether, TradeType>
...
export async function createTrade(): Promise<TokenTrade> {
  ...
  const swapRoute = new Route(
    [pool],
    CurrentConfig.tokens.in,
    Ether.onChain(SupportedChainId.ARBITRUM_ONE),
  )
...
export async function executeTrade(
  ...
  const res = await sendTransaction({...tx, from: walletAddress})
